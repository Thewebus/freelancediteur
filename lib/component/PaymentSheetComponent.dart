...
import 'package:freelancediteur/model/CheckoutResponse.dart';
import 'package:freelancediteur/model/LineItemModel.dart';
import 'package:freelancediteur/model/MyCartResponse.dart';
import 'package:freelancediteur/model/OrderResponse.dart';
...
import 'package:freelancediteur/screens/WebViewScreen.dart';
import 'package:freelancediteur/screens/sign_in_screen.dart';
import 'package:freelancediteur/utils/BookDetailWidget.dart';
import 'package:freelancediteur/utils/config.dart';
import 'package:freelancediteur/utils/constant.dart';
import 'package:freelancediteur/utils/flutterwave/core/TransactionCallBack.dart';
import 'package:freelancediteur/utils/flutterwave/flutterwave.dart';
import 'package:freelancediteur/utils/flutterwave/models/requests/standard_request.dart';
import 'package:freelancediteur/utils/flutterwave/view/view_utils.dart';
                ...
                children: <Widget>[
                  if (getStringAsync(PAYMENT_METHOD) == "native")
                    Row(
                      ...
                      children: [
                        Text(keyString(context, "lbl_choose_payment_method")!,
                    ...
                    onTap: () {
                      if (getStringAsync(PAYMENT_METHOD) == "native") {
                        ...
                        if (_currentTimeValue == 0)
                          openCheckout(
                              _razorPay, widget.total.toString().validate());
