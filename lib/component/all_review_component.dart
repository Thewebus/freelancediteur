...
import 'package:freelancediteur/adapterView/Review.dart';
...
import 'package:freelancediteur/screens/review_screen.dart';
...
class AllReviewComponent extends StatefulWidget {
  ...
  AllReviewComponent(
      this.mBookDetailsData, this.mIsFreeBook, this.isLoginIn, this.bookId,
      {this.onUpdate});
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  ...
                  style: TextStyle(
                      fontSize: mobile_font_size_large,
                ...
                Text(
                  ...
                  style: TextStyle(
                      fontSize: 18, color: appStore.textSecondaryColor),
                ),
                8.height,
                RatingBar.builder(
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Row(
              children: [
                Text(
                    getAvgReviewCount(widget.mBookDetailsData.reviews!)
                        .toString(),
                    style: primaryTextStyle(size: 36)),
                8.width,
                Column(
                  ...
                  children: [
                    ...
                    Text(
                        ...
                        .visible(widget.mBookDetailsData != null),
                  ],
                ),
              ],
            ),
        ...
        ).paddingRight(16).visible(widget.mBookDetailsData.reviewsAllowed! &&
            widget.mBookDetailsData.reviews!.length > 0)
      ],
    );
  }
}
