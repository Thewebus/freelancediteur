...
class AuthorDetailsHeaderComponent extends StatefulWidget {
  ...
  @override
  AuthorDetailsHeaderComponentState createState() =>
      AuthorDetailsHeaderComponentState();
}

class AuthorDetailsHeaderComponentState
    extends State<AuthorDetailsHeaderComponent> {
  @override
  void initState() {
    super.initState();
    init();
          ...
          Row(
            ...
            children: [
              Image.asset('assets/shop_icon.png',
                  height: 22, width: 22, fit: BoxFit.fill, color: Colors.white),
              8.width,
              Text(
                ...
                await launchUrl(
                    Uri.parse(widget.authorDetails!.shopUrl.validate()),
