...
class BookAttributeComponent extends StatefulWidget {
  ...
  BookAttributeComponent(
      {this.mBookDetailsData, this.checkVisible, this.mSampleFile});
        ...
        Text(
          ...
          style: boldTextStyle(size: 20, color: appStore.appTextPrimaryColor),
            ...
            .visible(isSingleSampleFile(
                    widget.mBookDetailsData.attributes!.length,
                    widget.mSampleFile) &&
                widget.checkVisible == true)
        ...
        Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              return Container(
                child: (widget.mBookDetailsData.attributes![i].name ==
                            SAMPLE_FILE &&
                        !widget.mBookDetailsData.attributes![i].visible)
                    ? Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              getAllAttribute(
                                  widget.mBookDetailsData.attributes![i]),
                              style: TextStyle(
                                  fontSize: fontSizeMedium,
                                  color: textSecondaryColor),
                            ),
