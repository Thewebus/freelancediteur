...
class BookDescriptionCategoryComponent extends StatefulWidget {
  ...
  @override
  BookDescriptionCategoryComponentState createState() =>
      BookDescriptionCategoryComponentState();
}

class BookDescriptionCategoryComponentState
    extends State<BookDescriptionCategoryComponent> {
  @override
  void initState() {
    super.initState();
    init();
