...
import 'package:freelancediteur/component/get_author_component.dart';
...
class BookDescriptionComponent extends StatefulWidget {
  ...
  BookDescriptionComponent(
      {this.mBookDetailsData,
      this.mIsFreeBook,
      this.myCartList,
      this.mBookId,
      this.mSampleFile,
      this.mDownloadFileArray});

  @override
  BookDescriptionComponentState createState() =>
      BookDescriptionComponentState();
}
    ...
    return Column(
      ...
      children: [
          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                  color: appStore.editTextBackColor, borderRadius: radius(12)),
        ...
        priceWidget(
                ...
                price: widget.mBookDetailsData!.price!,
                size: 20)
            .visible(!widget.mIsFreeBook!)
            .paddingSymmetric(horizontal: 16),
        32.height,
        Text(
        ...
        Row(
          ...
          children: [
            Image.asset("assets/sunglasses.png",
                width: 26, color: appStore.appTextPrimaryColor),
            8.width,
            Text(
          ...
          _settingModalBottomSheet(context, widget.mDownloadFileArray!,
              isSampleFile: true);
        }).paddingSymmetric(horizontal: 16),
        Html(
        ...
        16.height,
        BookDescriptionCategoryComponent(widget.mBookDetailsData)
            .visible(widget.mBookDetailsData!.categories!.length > 0),
        32.height,
