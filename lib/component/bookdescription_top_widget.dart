...
class BookDescriptionTopWidget extends StatefulWidget {
  ...
  @override
  BookDescriptionTopWidgetState createState() =>
      BookDescriptionTopWidgetState();
}
            ...
            builder: (context, c) {
              ...
              return Stack(
                ...
                children: [
                  Opacity(
                    opacity: 1 - opacity,
                    child: Text(widget.mBookDetailsData!.name.validate(),
                        style: boldTextStyle()),
                  ).center(),
                  Opacity(
                    opacity: opacity,
                    child: Stack(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          width: 260,
                          decoration: boxDecorationWithRoundedCorners(
                              borderRadius: radius(book_radius)),
                          ...
                          child: CachedNetworkImage(
                            ...
                            imageUrl: widget.mBookDetailsData!.images![0].src
                                .validate(),
                            fit: BoxFit.fill,
                          ),
                        ...
                        widget.mBookDetailsData!.images![0].src!.isNotEmpty),
                  ),
                  Transform.translate(
                    offset: widget.scrollPosition! <= 230
                        ? Offset(0, 24)
                        : Offset(0, context.height() * 0.050),
                    child: (widget.mBookDetailsData!.isPurchased! ||
                            widget.mIsFreeBook!)
                        ? AppButton(
                            color: PRIMARY_COLOR,
                            shapeBorder: RoundedRectangleBorder(
                                borderRadius: (widget.scrollPosition! >= 230)
                                    ? BorderRadius.zero
                                    : BorderRadius.circular(20)),
                            width: (widget.scrollPosition! >= 230)
                                ? context.width()
                                : context.width() / 2,
                            child: Text(
