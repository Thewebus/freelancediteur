...
class CategoryBookComponentState extends State<CategoryBookComponent> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        CategoryBookViewAllComponent(categoryBookData: widget.categoryBookData!)
          ...
          child: AnimationLimiter(
            child: ListView.builder(
              ...
              itemBuilder: (context, i) {
                Color bgColor =
                    bookBackgroundColor[i % bookBackgroundColor.length];
                    ...
                    child: GestureDetector(
                      child: Container(
                          ...
                          child: BookItemRoundedWidget(
                              bookData: widget.categoryBookData!.product![i],
                              bgColor: bgColor)),
                      onTap: () {
                        BookDescriptionScreen(
                                widget.categoryBookData!.product![i].id
                                    .toString(),
                                bgColor: bgColor)
                            .launch(context,
