...
class CategoryBookViewAllComponent extends StatefulWidget {
  ...
  @override
  CategoryBookViewAllComponentState createState() =>
      CategoryBookViewAllComponentState();
}

class CategoryBookViewAllComponentState
    extends State<CategoryBookViewAllComponent> {
  @override
  void initState() {
    super.initState();
    init();
