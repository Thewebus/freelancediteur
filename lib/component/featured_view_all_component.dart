...
class FeaturedViewAllComponent extends StatefulWidget {
  ...
  @override
  FeaturedViewAllComponentState createState() =>
      FeaturedViewAllComponentState();
}
...
class FeaturedViewAllComponentState extends State<FeaturedViewAllComponent> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
          ...
          child: Row(
            ...
            children: <Widget>[
              Container(
                height: 40,
                child: Center(
                  child: Text(keyString(context, "featured_books")!,
        ...
        onTap: () {
          ViewAllBooksScreen(
                  title: keyString(context, "featured_books"), futureBook: true)
              .launch(context);
