...
import 'package:freelancediteur/component/free_book_item_component.dart';
                ...
                AnimationLimiter(
                  child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        OfflineBookList bookDetail =
                            widget.downloadedList![index];
                      ...
                      separatorBuilder: (context, index) {
                        return Divider(
                            color: Colors.grey.withOpacity(0.3), height: 0);
                      },
