...
import 'package:freelancediteur/adapterView/UpsellBookList.dart';
...
class MoreBookFromAuthorComponent extends StatefulWidget {
  ...
  @override
  MoreBookFromAuthorComponentState createState() =>
      MoreBookFromAuthorComponentState();
}

class MoreBookFromAuthorComponentState
    extends State<MoreBookFromAuthorComponent> {
  @override
  void initState() {
    super.initState();
    init();
        ...
        Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return UpsellBookList(widget.bookDetailsData.upsellId![index])
                  .onTap(() {
