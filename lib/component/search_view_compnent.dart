              ...
              itemBuilder: (context, index) {
                ...
                return AnimationConfiguration.staggeredList(
                  ...
                  child: SelectedAnimationType(
                    scale: 5,
                    curves: getIntAsync(ANIMATION_TYPE_SELECTION_INDEX) ==
                            SLIDE_ANIMATION
                        ? Curves.decelerate
                        : Curves.fastLinearToSlowEaseIn,
                    child: ViewAllBookComponent(
                            bookData: mData, categoryName: categoryName)
                        .paddingOnly(left: 16, right: 16, top: 8, bottom: 8)
                        .onTap(() {
                      BookDescriptionScreen(
                              widget.mBookList![index].id.toString(),
                              bgColor: bgColor)
                          .launch(context,
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            fontSize: 20, color: appStore.appTextPrimaryColor),
                      ),
                      SizedBox(height: 10),
                    ],
                  ),
