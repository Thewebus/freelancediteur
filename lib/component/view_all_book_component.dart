...
class ViewAllBookComponentState extends State<ViewAllBookComponent> {
  ...
  Future<void> getBookPrice() async {
    if ((widget.bookData!.price.toString().isEmpty ||
                widget.bookData!.price.toString() == "0") &&
            (widget.bookData!.salePrice.toString().isEmpty ||
                widget.bookData!.salePrice.toString() == "0") &&
      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            Text(keyString(context, 'lbl_free')!,
                    style: boldTextStyle(color: Colors.green))
                .visible(mIsFreeBook),
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(widget.bookData!.salePrice, style: boldTextStyle())
                    .visible(widget.bookData!.salePrice.toString().isNotEmpty),
                16
                    .width
                    .visible(widget.bookData!.salePrice.toString().isNotEmpty),
                Row(
                  children: [
                    Text('${getStringAsync(CURRENCY_SYMBOL)}',
                            style: boldTextStyle(color: PRIMARY_COLOR))
                        .visible(widget.bookData!.regularPrice
                            .toString()
                            .isNotEmpty),
                    Text(
                      ...
                      style: boldTextStyle(
                          color:
                              widget.bookData!.salePrice.toString().isNotEmpty
                                  ? Colors.grey
                                  : PRIMARY_COLOR,
                          decoration:
                              widget.bookData!.salePrice.toString().isNotEmpty
