...
import 'package:freelancediteur/model/DefaultSettingModel.dart';
import 'package:freelancediteur/network/rest_api_call.dart';
import 'package:freelancediteur/screens/splash_screen.dart';
import 'package:freelancediteur/store/AppStore.dart';
import 'package:freelancediteur/utils/AppTheme.dart';
...
List<DefaultSettingModel> getDefaultAnimation =
    DefaultSettingModel.getDefaultAnimation;
...
void main() async {
  ...
  Firebase.initializeApp(
    ...
    OneSignal.initialize("8885aeb6-3d23-4008-8541-ce819f856da7");
...
Future<void> initMethod() async {
  ...
  selectedLanguageDataModel =
      getSelectedLanguageModel(defaultLanguage: DEFAULT_LANGUAGE_CODE);
...
Future<void> getCartItem() async {
  await getCartBook().then((value) {
    ...
    myCartList.clear();
    myCartList
        .addAll(mCart.map((model) => MyCartResponse.fromJson(model)).toList());
