...
class ViewEPubFileNew extends StatefulWidget {
  ...
  ViewEPubFileNew(this.mBookId, this.mBookName, this.mBookImage, this.downloads,
      this.isPDFFile, this._isFileExist);
  ...
  void dispose() {
    try {
      if (_epubReaderController != null) {
        ...
        // Afficher un message ou gérer cette situation où _epubReaderController est null
      }
    } catch (e) {
      print("Error disposing _epubReaderController: $e");
    }
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          appBar: appBarWidget(
            ...
            backWidget: Icon(Icons.arrow_back, color: appStore.iconColor)
                .onTap(() async {
              await backPress();
                    ...
                    builder: (context) => !isDownloadFile
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(
                                          top: spacing_standard_new),
                                      child: Text(percentageCompleted,
                                          style: boldTextStyle(
                                              size: 20,
                                              color: appStore
                                                  .appTextPrimaryColor)),
                        ...
                        : !widget.isPDFFile
                            ? _epubReaderController != null
                                ? EpubView(
                                    builders:
                                        EpubViewBuilders<DefaultBuilderOptions>(
                            ...
                            : Observer(
                                builder: (_) => Container(
                                  ...
                                  child: PDFView(
                                    ...
                                    nightMode: appStore.isDarkModeOn == true
                                        ? true
                                        : false,
                                    onPageChanged: (int? page, int? total) {
                                      setValue(
                                          PAGE_NUMBER +
                                              widget.mBookId.toString(),
                                          page);
                                      setState(() {
          ...
          floatingActionButton: Container(
            ...
            child: Text(
                keyString(context, "lbl_go_to")! +
                    "${widget.isPDFFile ? " ${appStore.page.validate()} / $mTotalPage" : ''}",
                style: boldTextStyle()),
          ).onTap(() async {
            if (!widget.isPDFFile) {
