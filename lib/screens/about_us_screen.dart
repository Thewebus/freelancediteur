    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Text(packageInfo.appName.toString(),
              style: boldTextStyle(color: PRIMARY_COLOR, size: 20)),
          ...
          AppButton(
            ...
            text: 'Visitez-nous\nwww.freelancediteur.com'.toString(),
            //text: keyString(context, 'lbl_purchase'),
            onTap: () {
              launchUrl(
                Uri.parse("https://www.freelancediteur.com/accueils"),
      ...
      bottomNavigationBar: Container(
        ...
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Text(keyString(context, 'llb_follow_us')!, style: boldTextStyle())
            ...
            Row(
              ...
              children: <Widget>[
                ...
                InkWell(
                  ...
                  child:
                      Image.asset("assets/ic_Inst.png", height: 35, width: 35)
                          .paddingAll(10),
                ...
                InkWell(
                  ...
                  child: Image.asset("assets/ic_Fb.png", height: 35, width: 35)
                      .paddingAll(10),
                ).visible(getStringAsync(FACEBOOK).isNotEmpty),
                InkWell(
                  onTap: () => commonLaunchUrl('${getStringAsync(CONTACT)}'),
                  child: Image.asset("assets/ic_CallRing.png",
                          height: 35, width: 35, color: PRIMARY_COLOR)
                      .paddingAll(10),
