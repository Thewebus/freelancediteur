...
import 'package:freelancediteur/component/author_list_component.dart';
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    searchWidget(context,
                        ...
                        hint: keyString(context, "lbl_search_by_author_name"),
                        onChanged: (string) {
                      setState(() {
                        mSearchList = mAuthorList
                            .where((u) => (u.firstName!
                    ...
                    AnimationLimiter(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          Color bgColor = authorBorderColor[
                              index % authorBorderColor.length];
                          return AnimationConfiguration.staggeredGrid(
                            ...
                            child: SelectedAnimationType(
                                    ...
                                    curves: getIntAsync(
                                        ...
                                        ? Curves.easeOut
                                        : Curves.easeOutBack,
                                    child: AuthorListComponent(
                                        mSearchList[index], bgColor))
                                .onTap(() {
                              AuthorDetails(
