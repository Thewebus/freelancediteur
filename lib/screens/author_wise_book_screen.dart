...
import 'package:freelancediteur/component/book_item_rounded_component.dart';
...
class AuthorWiseBookScreen extends StatefulWidget {
  ...
  AuthorWiseBookScreen(this.url, this.fullName,
      {this.authorDetails, this.authorDetails1, this.isDetail = false});
