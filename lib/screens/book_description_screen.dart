...
import 'package:freelancediteur/component/book_description_component.dart';
import 'package:freelancediteur/component/bookdescription_top_widget.dart';
...
class BookDescriptionScreenState extends State<BookDescriptionScreen>
    ...
    await isNetworkAvailable().then((bool) async {
      ...
      if (bool) {
        ...
        await getBookDetailsRestApi(request).then((res) async {
          ...
          if ((mBookDetailsData!.price.toString().isEmpty ||
                      mBookDetailsData!.price.toString() == "0") &&
                  (mBookDetailsData!.salePrice.toString().isEmpty ||
                      mBookDetailsData!.salePrice.toString() == "0") &&
                  ...
                  children: [
                    ...
                    GestureDetector(
                      child: Icon(Icons.close,
                          color: appStore.iconColor, size: 30),
  ...
  Widget build(BuildContext context) {
    appStore.isDarkModeOn
        ? setStatusBarColor(mIsLoading
            ? appStore.scaffoldBackground!
            : appStore.scaffoldBackground!)
        : setStatusBarColor(
            mIsLoading ? appStore.scaffoldBackground! : Colors.grey.shade300);
    return SafeArea(
      child: Scaffold(
          ...
          return Stack(
            children: [
              AnimatedCrossFade(
                    ...
                    slivers: [
                      SliverAppBar(
                        ...
                        backgroundColor: appStore.isDarkModeOn
                            ? appStore.appColorPrimaryLightColor
                            ...
                            children: [
                              IconButton(
                                ...
                                onPressed: () async {
                                  if (appStore.isLoggedIn) {
                                    Map? res =
                                        await MyCartScreen(isDescription: true)
                                            .launch(context);
                                    log(res);
                                    if (res != null) {
                              ...
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style:
                                      primaryTextStyle(size: 12, color: white),
                                ).paddingAll(4),
                  ...
                  crossFadeState: (mBookDetailsData != null && !mIsLoading)
