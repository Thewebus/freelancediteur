...
import 'package:freelancediteur/component/category_list_component.dart';
import 'package:freelancediteur/app_localizations.dart';
import 'package:freelancediteur/model/CategoriesListResponse.dart';
  ...
  Widget build(BuildContext context) {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            searchWidget(context,
                    ...
                    hint: keyString(context, "lbl_search_by_categories"),
                    onChanged: (string) {
              setState(() {
                mSearchList = mCategoriesList
                    .where((u) => (u.name!
            ...
            Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return CategoryListComponent(mSearchList[index])
                      .paddingOnly(left: 16, right: 16)
                      .onTap(() {
                    ViewAllBooksScreen(
                      isCategoryBook: true,
    ...
    return Scaffold(
      appBar: appBar(context,
          ...
          titleSpacing: 8,
          fontSize: widget._isShowBack ? 16 : 28),
      ...
      body: RefreshIndicator(
        ...
        child: Stack(
          children: <Widget>[
            ...
            Observer(builder: (context) {
              return noDataFound(
                      title: keyString(context, 'lbl_no_categories_found'))
                  .center()
                  .visible(!appStore.isLoading && mCategoriesList.isEmpty);
            })
          ],
        ),
      ),
