      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            SingleChildScrollView(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    Text(keyString(context, 'lbl_change_pwd')!,
                    ...
                    AppTextField(
                        ...
                        decoration:
                            inputDecoration(keyString(context, 'lbl_old_pwd'))),
                    16.height,
                    AppTextField(
                        ...
                        decoration:
                            inputDecoration(keyString(context, 'lbl_new_pwd'))),
                    16.height,
                    AppTextField(
                        ...
                        validator: (s) {
                          if (s!.trim().isEmpty)
                            return keyString(context, "lbl_confirm_pwd")! +
                                " " +
                                keyString(context, "lbl_field_required")!;
                          if (mNewPasswordCont.text !=
                              mConfirmPasswordCont.text)
                            return keyString(context, "lbl_pwd_not_match");
                          return null;
                        },
                        nextFocus: mConfirmPasswordNode,
                        decoration: inputDecoration(
                            keyString(context, 'lbl_confirm_pwd'))),
                    16.height,
                    AppButton(
                      color: PRIMARY_COLOR,
                      width: context.width(),
            ...
            Observer(
                builder: (context) =>
                    appLoaderWidget.visible(appStore.isLoading)).center(),
          ],
        ),
      ),
    );
