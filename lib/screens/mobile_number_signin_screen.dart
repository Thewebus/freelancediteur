...
import 'package:freelancediteur/screens/sign_up_screen.dart';
import 'package:freelancediteur/utils/PinEntryTextField.dart';
...
class MobileNumberSignInScreen extends StatefulWidget {
  ...
  @override
  MobileNumberSignInScreenState createState() =>
      MobileNumberSignInScreenState();
}
    ...
    return await _auth.verifyPhoneNumber(
      ...
      codeSent: (String verificationId, int? resendToken) async {
        ...
        await showInDialog(
          ...
          title: Text(keyString(context, "lbl_sms_code")!,
  ...
  Future<void> signInApi(req) async {
    ...
    await getLoginUserRestApi(req).then((res) async {
      ...
      if (error.toString() == "Invalid Credential.") {
        ...
        SignUpScreen(
                userName:
                    '${countryCode!.replaceAll('+', '') + numberController.text}')
            .launch(context);
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appBar(context,
          title: keyString(context, "lbl_otp_verification"), showBack: true),
