...
import 'package:freelancediteur/component/bookmark_list_component.dart';
import 'package:freelancediteur/app_localizations.dart';
import 'package:freelancediteur/model/BookmarkResponse.dart';
  ...
  Widget build(BuildContext context) {
    Widget mainView = (mBookList.length < 1)
        ? bookNotAvailableWidget(context,
                title: keyString(context, "lbl_you_don_t_have_a_bookmark")!,
                buttonTitle: keyString(context, "lbl_bookmark_now"))
            .center()
                ...
                AnimationLimiter(
                  child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        Color borderColor = bookBackgroundColor[
                        ...
                        return GestureDetector(
                          child: AnimationConfiguration.staggeredList(
                            ...
                            child: SelectedAnimationType(
                              ...
                              child: BookMarkListComponent(mBookList[index],
                                      borderColor: borderColor)
                                  .paddingOnly(top: 8, bottom: 8),
                            ),
                          ),
                          onTap: () async {
                            await BookDescriptionScreen(
    ...
    return Scaffold(
      ...
      appBar: appBar(context,
          showTitle: true, title: keyString(context, 'lbl_my_bookmark')),
      body: Stack(children: [
