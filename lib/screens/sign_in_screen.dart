...
import 'package:freelancediteur/component/forgot_password_component.dart';
import 'package:freelancediteur/model/LoginResponse.dart';
import 'package:freelancediteur/network/rest_api_call.dart';
import 'package:freelancediteur/screens/mobile_number_signin_screen.dart';
import 'package:freelancediteur/service/LoginService.dart';
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  @override
  void dispose() {
    setStatusBarColor(widget.isBookDescription!
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: <Widget>[
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text(keyString(context, "lbl_remember_me")!,
                        ...
                        32.height,
                        Text(keyString(context, 'lbl_or_continue_with')!,
                            style: secondaryTextStyle()),
                        16.height,
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              icon: Image.asset('assets/phone_icon.png',
