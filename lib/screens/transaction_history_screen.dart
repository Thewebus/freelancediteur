...
import 'package:freelancediteur/component/transaction_component.dart';
...
class TransactionHistoryScreenState extends State<TransactionHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:
          appBar(context, title: keyString(context, 'lbl_transaction_history')),
          ...
          children: [
            ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return TransactionComponent(transactionListData: mData)
                      .paddingBottom(16);
                }).visible(!appStore.isLoading && mOrderList.isNotEmpty),
            noDataFound(
                    title: keyString(context, 'lbl_no_transaction_data_found')!)
                .center()
                .visible(!appStore.isLoading && mOrderList.isEmpty),
