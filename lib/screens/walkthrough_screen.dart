...
import 'package:freelancediteur/component/walkthrough_component.dart';
        ...
        children: <Widget>[
                ...
                Align(
                  child: currentIndexPage == 0
                      ...
                      : AppButton(
                          ...
                          text: keyString(context, 'lbl_prev'),
          ...
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(keyString(context, 'lbl_skip')!,
                  style: primaryTextStyle(color: PRIMARY_COLOR)),
            ),
          )
        ],
      ),
