...
import 'package:freelancediteur/component/bookstore_slider_component.dart';
import 'package:freelancediteur/component/categorywise_book_component.dart';
import 'package:freelancediteur/component/featured_book_component.dart';
import 'package:freelancediteur/component/featured_view_all_component.dart';
import 'package:freelancediteur/component/new_book_all_component.dart';
import 'package:freelancediteur/component/new_book_component.dart';
import 'package:freelancediteur/component/suggested_book_component.dart';
import 'package:freelancediteur/component/suggested_view_all_component.dart';
import 'package:freelancediteur/component/you_like_book_component.dart';
import 'package:freelancediteur/main.dart';
import 'package:freelancediteur/model/DashboardResponse.dart';
import 'package:freelancediteur/model/HeaderModel.dart';
import 'package:freelancediteur/network/rest_api_call.dart';
import 'package:freelancediteur/screens/NoInternetConnection.dart';
import 'package:freelancediteur/screens/error_view_screeen.dart';
import 'package:freelancediteur/screens/view_all_book_screen.dart';
      ...
      if (bool) {
        await getDashboardDataRestApi().then((res) {
          ...
          if (dashboardResponse.socialLink != null) {
            ...
            setValue(
                PRIVACY_POLICY, dashboardResponse.socialLink!.privacyPolicy);
            setValue(TERMS_AND_CONDITIONS,
                dashboardResponse.socialLink!.termCondition);
            setValue(
                COPYRIGHT_TEXT, dashboardResponse.socialLink!.copyrightText);
          }
                    ...
                    SliverAppBar(
                      ...
                      title: Text(
                        keyString(context, "lbl_hello")! +
                            ' ' +
                            (appStore.firstName.isEmpty
                                ? keyString(context, "lbl_guest")!
                                : appStore.firstName),
                        style:
                            boldTextStyle(color: appStore.appTextPrimaryColor),
                      ).visible(
                          mNewestBookModel.isNotEmpty && innerBoxIsScrolled),
                    )
                  ];
                },
                    ...
                    child: Column(
                      ...
                      children: [
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            titleSilverAppBarWidget(context,
                                title1: keyString(context, "lbl_hello")!,
                                title2: appStore.firstName.isEmpty
                                    ? keyString(context, "lbl_guest")!
                                    : appStore.firstName,
                                isHome: true),
                            16.height,
                            Text(
                              ...
                              style: boldTextStyle(size: 20),
                                ...
                                .paddingLeft(16),
                            16.height,
                            BookStoreSliderComponent(mHeaderModel: mHeaderModel)
                            ...
                            16.height,
                            NewBookAllComponent(
                                mNewestBookModel: mNewestBookModel),
                            NewBookComponent(mNewestBookModel: mNewestBookModel)
                                .visible(mNewestBookModel.isNotEmpty),
                            16.height,
                            FeaturedViewAllComponent(
                                    mFeaturedBookModel: mFeaturedBookModel)
                                .visible(mFeaturedBookModel.isNotEmpty),
                            FeaturedBookComponent(
                                    mFeaturedBookModel: mFeaturedBookModel)
                                .visible(mFeaturedBookModel.isNotEmpty),
                            16.height.visible(mSuggestedBooksModel.isNotEmpty),
                            SuggestedViewAllComponent(
                                    mSuggestedBooksModel: mSuggestedBooksModel)
                                .visible(mSuggestedBooksModel.isNotEmpty),
                            SuggestedBookComponent(
                                    mSuggestedBooksModel: mSuggestedBooksModel)
                                .visible(mSuggestedBooksModel.isNotEmpty),
                            GestureDetector(
                                child: Container(
