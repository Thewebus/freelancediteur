...
import 'package:freelancediteur/component/free_book_list_component.dart';
import 'package:freelancediteur/component/purchase_book_list_component.dart';
            ...
            children: [
              (!mIsLoading)
                  ? ListView(
                      ...
                      children: [
                        if (_sliding == 0)
                          PurchaseBookListComponent(mBookList: mBookList),
                        if (_sliding == 1)
