...
import 'package:freelancediteur/screens/about_us_screen.dart';
import 'package:freelancediteur/screens/author_list_screen.dart';
import 'package:freelancediteur/screens/category_list_screen.dart';
import 'package:freelancediteur/screens/change_password_screen.dart';
import 'package:freelancediteur/screens/default_setting_screen.dart';
import 'package:freelancediteur/screens/edit_profile_screen.dart';
import 'package:freelancediteur/screens/my_bookmark_screen.dart';
import 'package:freelancediteur/screens/my_cart_screen.dart';
import 'package:freelancediteur/screens/sign_in_screen.dart';
import 'package:freelancediteur/screens/transaction_history_screen.dart';
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(keyString(context, 'title_account')!,
              ...
              SettingItemWidget(
                ...
                title: appStore.firstName.validate() +
                    ' ' +
              ...
              Text(keyString(context, 'lbl_content')!,
                      style: boldTextStyle(size: 14))
                  .paddingOnly(left: 16, right: 16, top: 8),
              Row(
                children: [
                  Text(keyString(context, 'lbl_mode')!,
              ...
              SettingItemWidget(
                ...
                decoration: BoxDecoration(borderRadius: radius()),
                onTap: () {
                  DefaultSettingScreen().launch(context,
                      pageRouteAnimation: PageRouteAnimation.Slide);
                },
              ),
              SettingItemWidget(
              ...
              Divider(color: Colors.grey),
              Text(keyString(context, 'lbl_list')!,
                      style: boldTextStyle(size: 14))
                  .paddingOnly(left: 16, right: 16, top: 8),
              SettingItemWidget(
                padding: EdgeInsets.all(16),
              ...
              SettingItemWidget(
                ...
                decoration: BoxDecoration(borderRadius: radius()),
                onTap: () {
                  CategoriesListScreen(isShowBack: true).launch(context,
                      pageRouteAnimation: PageRouteAnimation.Slide);
                },
              ),
              SettingItemWidget(
              ...
              Divider(color: Colors.grey),
              Text(keyString(context, 'lbl_about')!,
                      style: boldTextStyle(size: 14))
                  .paddingOnly(left: 16, right: 16, top: 8),
              SettingItemWidget(
                padding: EdgeInsets.all(16),
