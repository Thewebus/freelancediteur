...
import 'package:freelancediteur/component/search_view_compnent.dart';
              ...
              children: <Widget>[
                ...
                searchWidget(context,
                    ...
                    onFieldSubmitted: (dynamic) {
                      ...
                      getSearchHistory();
                      getViewAllBookData(searchBookController.text,
                          isNewSearch: true);
                    },
                    isSearch: true,
                    textToSpeech: () {
                ...
                Row(
                  ...
                  children: <Widget>[
                    Text(keyString(context, "lbl_recent_search")!,
